"""
Django settings for snapcove_backend project.
...
SECRET_KEY = 'django-insecure-oxh3*#9k9&piif8wmy$*4)fv=7!*_3a+hddh+crdnn1t^u%=bt'
...
ROOT_URLCONF = 'snapcove_backend.urls'
